<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminWeb.Master" AutoEventWireup="true" CodeBehind="EditKindList.aspx.cs" Inherits="WebShop.Admin.EditKindList"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="main-content" style="width:80%;">
              ...
              <div class="content-box-header">
                <h3 style="cursor: s-resize;">添加/修改产品种类信息</h3>
